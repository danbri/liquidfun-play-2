...
https://github.com/Birch-san/box2d-wasm/blob/liquidfun/box2d-wasm/Box2D.idl
*/
...
export const drawBuffer: DrawBuffer = {
  ...
  circles: {
    ...
    colours: growableColourArray,
    colour: new Float32Array([0.0075, 0.0075, 0.0075, 1]) // danbri
  },
  particles: {
    centres: particleCentreArray,
    radii: randomRadiusArray,
    systemRadius: 1,
    colour: new Float32Array([1., 0.0, 0.0, 1.0]) // danbri
  },
  lineVertices: growableVec2Array
}
